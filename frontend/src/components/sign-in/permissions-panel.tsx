...
export function PermissionsPanel() {
  ...
  return (
    <div className="flex min-h-[280px] flex-col justify-center border-t border-border bg-[var(--bg-elev)] px-6 py-10 md:min-h-screen md:border-t-0 md:border-l md:px-12 lg:px-14">
      <div className="mx-auto w-full max-w-[440px]">
        ...
        <ul className="mt-3.5 flex flex-col gap-2.5">
          {scope.denied.map((item) => (
            <li key={item} className="flex items-start gap-3">
              <X size={14} className="mt-0.5 shrink-0 text-[var(--text-dim)]" />
